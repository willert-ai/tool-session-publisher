...
*Version 1.3 — 2026-05-18. Added Layer 1 rule 16 (link placement) and "Post-publish protocol" section based on X algorithm signal analysis (xai-org/x-algorithm, Jan 2026). Layer 2 rules renumbered 17–24 (was 16–23). Source: `strategy/DELTA_algo-vs-drafting-guide-2026-05-18.md`.*
